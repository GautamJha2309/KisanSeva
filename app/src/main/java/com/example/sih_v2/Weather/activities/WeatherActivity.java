package com.example.sih_v2.Weather.activities;
...
import com.example.sih_v2.Weather.AlarmReceiver;
import com.example.sih_v2.Weather.Constants;
import com.example.sih_v2.Weather.adapters.ViewPagerAdapter;
import com.example.sih_v2.Weather.adapters.WeatherRecyclerAdapter;
import com.example.sih_v2.Weather.fragments.RecyclerViewFragment;
import com.example.sih_v2.Weather.models.Weather;
import com.example.sih_v2.Weather.tasks.GenericRequestTask;
import com.example.sih_v2.Weather.tasks.ParseResult;
import com.example.sih_v2.Weather.tasks.TaskOutput;
...
public class WeatherActivity extends AppCompatActivity implements LocationListener {
   ...
   /* private void updateView(String lang) {
        ...
        todayTemperature.setText(resources.getString(R.string._0_c));
        todayDescription.setText(resources.getString(R.string.no_data));
        todayWind.setText(resources.getString(R.string.wind_0_m_s));
        todayPressure.setText(resources.getString(R.string.pressure_0_hpa));
        todayHumidity.setText(resources.getString(R.string.humidity_0));
        todaySunrise.setText(resources.getString(R.string.sunrise_00_00));
        todaySunset.setText(resources.getString(R.string.sunset_00_00));
    }
*/
